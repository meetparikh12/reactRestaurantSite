                ...
                <section style={{background: "#000"}} className="menu-items probootstrap-section probootstrap-bg-white">
                    <div className="container">
                        ...
                        <div className="col-md-6">
                            <ul className="menus">
                            <li>
                                <figure className="image"><img src={img_square_1} className="img-rounded rounded-circle rounded" alt="Food"/></figure>
                                <div className="text">
                            ...
                            <li>
                                <figure className="image"><img src={img_square_2} className="img-rounded rounded-circle rounded" alt="Food"/></figure>
                                <div className="text">
                            ...
                            <li>
                                <figure className="image"><img src={img_square_3} className="img-rounded rounded-circle rounded" alt="Food"/></figure>
                                <div className="text">
                            ...
                            <li>
                                <figure className="image"><img src={img_square_4} className="img-rounded rounded-circle rounded" alt="Food"/></figure>
                                <div className="text">
                        ...
                        <div className="col-md-6">
                            <ul className="menus">
                            <li>
                                <figure className="image"><img src={img_square_5} className="img-rounded rounded-circle rounded" alt="Food"/></figure>
                                <div className="text">
